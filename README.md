...
after all, you will need to install the llama-server and download the Qwen3-4B-Instruct-2507-Q5_K_M.gguf model from hugging face, accessible from [hugging faces](https://huggingface.co/unsloth/Qwen3-4B-Instruct-2507-GGUF), if you decide to use other model, it must not use thinking tags, and you need to change the path to it at src\reality_mesa\nlp\llm\llm.py. 

## If your computer manages llama-server for cuda 12, you may run the following script

python ./setup.py

this will automatically download the model and correct llama-server
